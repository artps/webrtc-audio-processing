...
// Allow build.rs to override this at compile time.
#ifndef WAP_SAMPLE_RATE_HZ
#define WAP_SAMPLE_RATE_HZ 48000
#endif
...
namespace webrtc_audio_processing
{
  ...
  const int SAMPLE_RATE_HZ = WAP_SAMPLE_RATE_HZ;
  ...
  static_assert(
      SAMPLE_RATE_HZ == 48000 || SAMPLE_RATE_HZ == 32000 ||
          SAMPLE_RATE_HZ == 16000 || SAMPLE_RATE_HZ == 8000,
      "AudioProcessing supports only 48k/32k/16k/8k");
